 ...
 * cargar el Dictionary, el segundo una ruta donde cargar el LetterSet, el tercero una letra
 ...
 *
 * El programa cargará el diccionario y el LetterSet, para luego hacer que el iterador recorra
 * las palabras validas y se impriman por pantalla
 *
 * <strong>Ejemplo de ejecución:</strong>\n
 * Orden: partida_letras data/diccionario.txt data/letras.txt L 9\n
 * Output:\n
 * LETRAS DISPONIBLES:\n
 * E O I E C I L X O \n
 * SOLUCIONES:\n
